            ...
            <tr>
              <td>
                <div class="row-actions">
                  ...
                  ${lead.status !== "Matriculado" ? `<button class="row-action-button lead-action-button lead-enroll-btn" data-convert-lead="${lead.id}" type="button" title="Realizar matrícula" aria-label="Realizar matrícula"><span class="lead-action-icon lead-action-contract" aria-hidden="true"></span></button>` : ""}

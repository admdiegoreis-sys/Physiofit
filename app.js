            ...
            <tr>
              <td>
                <div class="row-actions">
                  ...
                  <button class="row-action-button lead-action-button lead-register-student-btn" data-register-student-lead="${lead.id}" type="button" title="Cadastrar cliente" aria-label="Cadastrar cliente"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><line x1="19" y1="8" x2="19" y2="14"/><line x1="22" y1="11" x2="16" y2="11"/></svg></button>
